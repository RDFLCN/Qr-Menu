...
$categories = $pdo->query("SELECT * FROM categories ORDER BY `order` ASC")->fetchAll(PDO::FETCH_ASSOC);
?>
...
<body>
  ...
  <div class="container">
    ...
    <div id="order-status">
      ...
      <div id="orderList"><p>Yükleniyor...</p></div>
    </div>
  </div>
  ...
  <script>
    ...
    function callWaiter() {
  // Table ID'yi PHP'den aktaralım
  const tableId = <?= $table_id ?>;

  // AJAX isteği ile çağrı bildirimi gönderiliyor
